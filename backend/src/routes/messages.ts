...
// Helper: envia WhatsApp via canal disponível. Reexporta a implementacao
// partilhada em lib/whatsappSend para evitar duplicacao (havia duas copias
// desta funcao com codigo divergente, o que gerou bugs de envio de media
// - ex: base64 em formato Data URL so estava numa das copias).
